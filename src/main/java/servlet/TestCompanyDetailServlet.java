...
/**
 * 企業詳細・編集サーブレット（テスト用 - 権限チェック無効）
 */
public class TestCompanyDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        if (companyIdStr == null || companyIdStr.trim().isEmpty()) {
            response.sendRedirect(request.getContextPath() + "/test-company-detail.html");
            return;
        }
        ...
        try {
            ...
            if (company == null) {
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("/test-company-detail.html");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            // 詳細画面に戻る
            response.sendRedirect(request.getContextPath() + "/TestCompanyDetailServlet?companyId=" + companyId);
